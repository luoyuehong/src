...
public class MailLocalhostTest {
    ...
    private static final String FULL_MAIL_URL = "http://127.0.0.1:12345/api/v0.0.1/mail/send?to=22232647@qq.com&title=我是没有附件的主题&content=我是没有附件的内容";

    private static final String EQUAL_SIGN = "=";

    //发送多收件人，使用;分隔收件人邮箱
    private static final String TEST_MAIL = "22232647@qq.com";

    private static final String PARAM_SEPARATOR = "&";
    
    private static final String PARAM_QUESTION_MARK = "?";
    

    @Test
    public void testSendTextMaiLocal1() {
        StringBuilder builder = new StringBuilder(MAIL_URL);
        builder.append(PARAM_QUESTION_MARK)
        		.append("to")
                .append(EQUAL_SIGN)
                .append(TEST_MAIL)
        ...
        //assertTrue(rest.postForObject(FULL_MAIL_URL, null, Boolean.class));
        MailUtil.getInstance().send(TEST_MAIL,"我是没有附件的主题","我是没有附件的内容");
    }
    ...
    public void testSendAttachmentMailLocal() throws Throwable {
        ...
        MailUtil.getInstance().send(TEST_MAIL,"title","content",attachmentFile);
    }
